...
contract RiscZeroGroth16Verifier is IRiscZeroVerifier, Groth16Verifier {
    ...
    constructor(bytes32 bn254_control_id) {
        // (CONTROL_ROOT_0, CONTROL_ROOT_1) = splitDigest(control_root);
        CONTROL_ROOT_0 = 0x0e8ed4340930069162f5fbc957a016a5;
        CONTROL_ROOT_1 = 0x2e7edecb6fd9ca4733501ee430425d77;
    ...
    // function verifySnark(bytes calldata seal, bytes32 imageId,bytes memory journal) public view returns (bool) {
    //     return verify(seal, imageId, sha256(journal));
    // }
